...
:: Se app.py nao estiver aqui, verifica se esta no diretorio pai
if not exist "app.py" (
    if exist "..\app.py" (
        ...
        echo [!] AVISO: app.py nao encontrado no diretorio atual ou superior.
    )
)

:: Confirma se mudou corretamente
if exist "app.py" (
    echo [*] Raiz do projeto confirmada: %CD%
) else (
